      ...
      <section id="services" className={styles.services}>
        <div className={styles.servicesContainer}>
          <div className={styles.serviceCard}>
            ...
            <Link href="/individual-coaching" className={styles.learnMoreButton}>Learn more</Link>
          </div>
          ...
          <div className={styles.serviceCard}>
            ...
            <Link href="/group-coaching" className={styles.learnMoreButton}>Learn more</Link>
          </div>
        </div>
      </section>
        ...
        <div className={styles.additionalCoachingContainer}>
          ...
          <div className={styles.coachingGrid}>
            <div className={styles.coachingItem}>
              ...
              <Link href="/individual-coaching#individual-coaching-services" className={styles.moreLink}>More</Link>
            </div>
            <div className={styles.coachingItem}>
...
Do you want more from your Employee Assistance Program (EAP) counseling services or any counselor you partner with? Look no further!
              ...
              <Link href="/individual-coaching#corporate-services" className={styles.moreLink}>More</Link>
            </div>
            <div className={styles.coachingItem}>
              ...
              <Link href="/group-coaching" className={styles.moreLink}>More</Link>
            </div>
          </div>
        </div>
      </section>
